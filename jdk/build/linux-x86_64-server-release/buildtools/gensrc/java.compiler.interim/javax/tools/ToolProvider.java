...
public class ToolProvider {
    ...
    private static final String systemJavaCompilerModule = "jdk.compiler.interim";
    ...
    private static final String systemDocumentationToolModule = "jdk.javadoc.interim";
