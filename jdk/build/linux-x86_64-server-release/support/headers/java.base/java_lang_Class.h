...
/*
 * Class:     java_lang_Class
 * Method:    initClassName
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_java_lang_Class_initClassName
  (JNIEnv *, jobject);
...
/*
 * Class:     java_lang_Class
 * Method:    getRecordComponents0
 * Signature: ()[Ljava/lang/reflect/RecordComponent;
 */
JNIEXPORT jobjectArray JNICALL Java_java_lang_Class_getRecordComponents0
  (JNIEnv *, jobject);
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_java_lang_Class_isRecord0
  (JNIEnv *, jobject);
 ...
 * Signature: ()Ljava/lang/Class;
 */
JNIEXPORT jclass JNICALL Java_java_lang_Class_getNestHost0
  (JNIEnv *, jobject);

/*
 * Class:     java_lang_Class
 * Method:    getNestMembers0
 * Signature: ()[Ljava/lang/Class;
 */
JNIEXPORT jobjectArray JNICALL Java_java_lang_Class_getNestMembers0
  (JNIEnv *, jobject);
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_java_lang_Class_isHidden
  (JNIEnv *, jobject);

/*
 * Class:     java_lang_Class
 * Method:    getPermittedSubclasses0
 * Signature: ()[Ljava/lang/Class;
 */
JNIEXPORT jobjectArray JNICALL Java_java_lang_Class_getPermittedSubclasses0
  (JNIEnv *, jobject);

/*
 * Class:     java_lang_Class
 * Method:    getClassFileVersion0
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_java_lang_Class_getClassFileVersion0
  (JNIEnv *, jobject);
