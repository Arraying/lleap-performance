...
#define sun_nio_fs_LinuxNativeDispatcher_SUPPORTS_XATTR 8L
 ...
 * Signature: (IJJI)I
 */
JNIEXPORT jint JNICALL Java_sun_nio_fs_LinuxNativeDispatcher_posix_1fadvise
 ...
 * Signature: (IIJ)I
 */
JNIEXPORT jint JNICALL Java_sun_nio_fs_LinuxNativeDispatcher_directCopy0
