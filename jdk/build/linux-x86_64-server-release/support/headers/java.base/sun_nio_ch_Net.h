 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_sun_nio_ch_Net_isReusePortAvailable0
  (JNIEnv *, jclass);
...
/*
 * Class:     sun_nio_ch_Net
 * Method:    shouldShutdownWriteBeforeClose0
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_sun_nio_ch_Net_shouldShutdownWriteBeforeClose0
  (JNIEnv *, jclass);

/*
 * Class:     sun_nio_ch_Net
 * Method:    shouldSetBothIPv4AndIPv6Options0
 * Signature: ()Z
 */
...
/*
 * Class:     sun_nio_ch_Net
 * Method:    canUseIPv6OptionsWithIPv4LocalAddress0
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_sun_nio_ch_Net_canUseIPv6OptionsWithIPv4LocalAddress0
  (JNIEnv *, jclass);
 ...
 */
JNIEXPORT jint JNICALL Java_sun_nio_ch_Net_accept
 ...
 * Class:     sun_nio_ch_Net
 * Method:    pollConnect
 * Signature: (Ljava/io/FileDescriptor;J)Z
 */
JNIEXPORT jboolean JNICALL Java_sun_nio_ch_Net_pollConnect
 ...
 * Signature: (Ljava/io/FileDescriptor;)I
 */
JNIEXPORT jint JNICALL Java_sun_nio_ch_Net_available
  (JNIEnv *, jclass, jobject);
 ...
 */
JNIEXPORT jint JNICALL Java_sun_nio_ch_Net_sendOOB
 ...
 */
JNIEXPORT jboolean JNICALL Java_sun_nio_ch_Net_discardOOB
  (JNIEnv *, jclass, jobject);
