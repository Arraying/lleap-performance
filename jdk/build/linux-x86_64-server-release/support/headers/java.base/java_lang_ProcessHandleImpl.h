...
extern "C" {
#endif
#undef java_lang_ProcessHandleImpl_REAPER_DEFAULT_STACKSIZE
#define java_lang_ProcessHandleImpl_REAPER_DEFAULT_STACKSIZE 131072LL
#undef java_lang_ProcessHandleImpl_NOT_A_CHILD
#define java_lang_ProcessHandleImpl_NOT_A_CHILD -2L
#undef java_lang_ProcessHandleImpl_STARTTIME_ANY
#define java_lang_ProcessHandleImpl_STARTTIME_ANY 0LL
#undef java_lang_ProcessHandleImpl_STARTTIME_PROCESS_UNKNOWN
#define java_lang_ProcessHandleImpl_STARTTIME_PROCESS_UNKNOWN -1LL
/*
