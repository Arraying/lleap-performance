...
JNIEXPORT jobject JNICALL Java_java_lang_invoke_MethodHandleNatives_resolve
  (JNIEnv *, jclass, jobject, jclass, jint, jboolean);
 ...
 */
JNIEXPORT void JNICALL Java_java_lang_invoke_MethodHandleNatives_copyOutBootstrapArguments
  (JNIEnv *, jclass, jclass, jintArray, jint, jint, jobjectArray, jint, jboolean, jobject);
