...
public final class compiler extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "compiler.err.annotation.array.too.large", "Annotation array element too large in \"{0}\"" },
            ...
            { "compiler.err.call.must.only.appear.in.ctor", "explicit constructor invocation may only appear within a constructor body" },
            ...
            { "compiler.err.cant.assign.initialized.before.ctor.called", "assignment to initialized field ''{0}'' may only appear after an explicit constructor invocation" },
            ...
            { "compiler.err.cant.attach.type.annotations", "Cannot attach type annotations {0} to {1}.{2}:\n{3}" },
            ...
            { "compiler.err.cant.ref.before.ctor.called", "reference to {0} may only appear after an explicit constructor invocation" },
            ...
            { "compiler.err.class.method.or.field.expected", "class, interface, annotation type, enum, record, method or field expected" },
            ...
            { "compiler.err.ctor.calls.not.allowed.here", "explicit constructor invocation not allowed here" },
            ...
            { "compiler.err.default.and.both.boolean.values", "switch has both boolean values and a default label" },
            ...
            { "compiler.err.illegal.char.literal.multiple.surrogates", "character literal contains more than one UTF-16 code unit" },
            ...
            { "compiler.err.illegal.digit.in.binary.literal", "illegal digit in a binary literal" },
            { "compiler.err.illegal.digit.in.octal.literal", "illegal digit in an octal literal" },
            ...
            { "compiler.err.implicit.class.does.not.have.main.method", "compact source file does not have main method in the form of void main() or void main(String[] args)" },
            { "compiler.err.implicit.class.should.not.have.package.declaration", "compact source file should not have package declaration" },
            { "compiler.err.import.module.does.not.read", "module {0} does not read: {1}" },
            { "compiler.err.import.module.does.not.read.unnamed", "unnamed module does not read: {0}" },
            { "compiler.err.import.module.not.found", "imported module not found: {0}" },
            ...
            { "compiler.err.local.cant.be.inst.static", "local {0} {1} cannot be instantiated from a static context" },
            ...
            { "compiler.err.method.does.not.override.superclass", "{0} in {1} does not override or implement a method from a supertype" },
            { "compiler.err.missing.meth.body.or.decl.abstract", "method {0} in {1} is missing a method body, or should be declared abstract" },
            ...
            { "compiler.err.non.canonical.constructor.invoke.another.constructor", "constructor is not canonical, so it must invoke another constructor of class {0}" },
            ...
            { "compiler.err.redundant.superclass.init", "redundant explicit constructor invocation" },
            ...
            { "compiler.err.return.before.superclass.initialized", "''return'' not allowed before explicit constructor invocation" },
            ...
            { "compiler.err.source.target.conflict", "specified target release {1} is too old for the specified source release {0}\n--release {1} is recommended when compiling code to run on JDK {1}" },
            ...
            { "compiler.err.statement.not.expected", "statements not expected outside of methods and initializers" },
            ...
            { "compiler.err.static.methods.cannot.be.annotated.with.override", "static method {0} in {1} cannot be annotated with @Override" },
            ...
            { "compiler.err.target.default.source.conflict", "specified target release {1} is too old for the default source release {0}\n--release {1} is recommended when compiling code to run on JDK {1}" },
            ...
            { "compiler.err.type.annotation.inadmissible", "{0} not expected here\n(to annotate a qualified type, write {1}.{2})" },
            ...
            { "compiler.err.unconditional.pattern.and.both.boolean.values", "switch has both boolean values and an unconditional pattern" },
            ...
            { "compiler.err.use.of.underscore.not.allowed", "underscore not allowed here\nas of release 9, ''_'' is a keyword, and may not be used as an identifier\nas of release 22, ''_'' can be used as a name in the declaration of unnamed patterns, local variables, exception parameters or lambda parameters" },
            { "compiler.err.use.of.underscore.not.allowed.non.variable", "underscore not allowed here" },
            ...
            { "compiler.misc.bad.requires.flag", "invalid flag for \"requires java.base\": {0}" },
            ...
            { "compiler.misc.doesnt.extend.sealed", "class {0} must extend sealed class" },
            { "compiler.misc.doesnt.implement.sealed", "{0} {1} must extend sealed interface" },
            ...
            { "compiler.misc.feature.flexible.constructors", "flexible constructors" },
            { "compiler.misc.feature.implicit.classes", "implicitly declared classes" },
            { "compiler.misc.feature.java.base.transitive", "transitive modifier for java.base" },
            { "compiler.misc.feature.module.imports", "module imports" },
            ...
            { "compiler.misc.feature.primitive.patterns", "primitive patterns" },
            ...
            { "compiler.misc.not.an.intf.component", "component type {0} is not an interface or java.lang.Object" },
            ...
            { "compiler.misc.source.no.bootclasspath", "not setting the bootstrap class path may lead to class files that cannot run on JDK {0}\n--release {0} is recommended instead of -source {0} because it sets the bootstrap class path automatically" },
            { "compiler.misc.source.no.bootclasspath.with.target", "not setting the bootstrap class path may lead to class files that cannot run on JDK 8\n--release {0} is recommended instead of -source {0} -target {1} because it sets the bootstrap class path automatically" },
            { "compiler.misc.source.no.system.modules.path", "not setting the location of system modules may lead to class files that cannot run on JDK {0}\n--release {0} is recommended instead of -source {0} because it sets the location of system modules automatically" },
            { "compiler.misc.source.no.system.modules.path.with.target", "not setting the location of system modules may lead to class files that cannot run on JDK {0}\n--release {0} is recommended instead of -source {0} -target {1} because it sets the location of system modules automatically" },
            ...
            { "compiler.misc.type.annotation", "type annotations {0} are" },
            { "compiler.misc.type.annotation.1", "type annotation {0} is" },
            ...
            { "compiler.warn.attempt.to.use.value.based.where.identity.expected", "use of a value-based class with an operation that expects reliable identity" },
            ...
            { "compiler.warn.ineffectual.extern.method.enum", "externalization-related method {0} is not effective in an enum class" },
            { "compiler.warn.ineffectual.externalizable.method.record", "externalization-related method {0} is not effective in a record class" },
            ...
            { "compiler.warn.runtime.invisible.parameter.annotations", "the RuntimeVisibleParameterAnnotations and RuntimeInvisibleParameterAnnotations attributes in: {0} cannot be mapped to the method''s parameters" },
            { "compiler.warn.runtime.visible.invisible.param.annotations.mismatch", "the length of parameters in RuntimeVisibleParameterAnnotations attribute and RuntimeInvisibleParameterAnnotations attribute in: {0} do not match, ignoring both attributes" },
            ...
            { "compiler.warn.source.no.bootclasspath", "bootstrap class path is not set in conjunction with -source {0}\n{1}" },
            { "compiler.warn.source.no.system.modules.path", "location of system modules is not set in conjunction with -source {0}\n{1}" },
