...
public final class javac extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "javac.opt.Werror", "Terminate compilation if any warnings occur" },
            { "javac.opt.Werror.custom", "Specify lint categories for which warnings should terminate compilation,\nseparated by comma. Precede a key by ''-'' to exclude the specified category.\nUse --help-lint to see the supported keys." },
            ...
            { "javac.opt.Xlint", "Enable recommended lint warning categories. In this release, all\navailable lint warning categories are recommended." },
            { "javac.opt.Xlint.alias.of", "Deprecated alias for ''{0}'' with an identical effect. Users are encouraged to use\n                         ''{0}'' instead of ''{1}'' for all current and future uses." },
            { "javac.opt.Xlint.all", "Enable all lint warning categories" },
            { "javac.opt.Xlint.custom", "Lint warning categories to enable or disable, separated by comma.\nPrecede a key by ''-'' to disable the specified category. Use\n''--help-lint'' to show supported keys and which categories are\nenabled by default." },
            ...
            { "javac.opt.Xlint.desc.dangling-doc-comments", "Warn about dangling documentation comments, not attached to any declaration." },
            ...
            { "javac.opt.Xlint.desc.identity", "Warn about uses of value-based classes where an identity class is expected." },
            { "javac.opt.Xlint.desc.incubating", "Warn about use of incubating modules." },
            ...
            { "javac.opt.Xlint.desc.restricted", "Warn about use of restricted methods." },
            ...
            { "javac.opt.Xlint.none", "Disable all lint warning categories" },
            ...
            { "javac.opt.help.lint", "Print the supported keys for -Xlint and -Werror" },
            { "javac.opt.help.lint.enabled.by.default", "The following lint warning categories are enabled by default:" },
            { "javac.opt.help.lint.footer", "Categories and their aliases can be used interchangeably; for example, the flag\n''-Xlint:{0},{1}'' would be redundant." },
            ...
            { "javac.opt.lineDocComments", "Disable support for documentation comments with lines beginning ''///''" },
            ...
            { "javac.opt.nowarn", "Generate only mandatory warnings" },
            ...
            { "javac.opt.preview", "Enable preview language features. Also disables the ''preview'' lint category.\nTo be used in conjunction with either -source or --release." },
