...
public final class standard extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "doclet.PreviewJavaSERequiresTransitiveJavaBase", "Indirect exports from the <code>java.base</code> module are associated with the <code>requires transitive java.base</code> directive, which is a preview feature of the Java language.<br>Programs can only use <code>requires transitive java.base</code> when preview features are enabled.<br>Preview features may be removed in a future release, or upgraded to permanent features of the Java Platform.<br>" },
            ...
            { "doclet.RestrictedTrailingNote2", "Restricted methods are unsafe, and, if used incorrectly, might crash the JVM or result in memory corruption." },
            ...
            { "doclet.help.keyboard_navigation.escape", "Type {0} to clear the input and release keyboard focus in any input field." },
            { "doclet.help.keyboard_navigation.filter", "Type {0} to access the filter input field in the sidebar of class  pages." },
            { "doclet.help.keyboard_navigation.index", "Type {0} to access the search input field in any page." },
            { "doclet.help.keyboard_navigation.intro", "Documentation pages provide keyboard shortcuts to facilitate access to common navigation tasks." },
            { "doclet.help.keyboard_navigation.search", "Type {0}/{1}/{2} to select list items after entering a search term in a search or filter input field." },
            ...
            { "doclet.help.releases.body.refer", "Some summary pages (New API, Deprecated) allow you to filter the contents of the page according to the release in which the declaration was introduced or deprecated." },
            { "doclet.help.releases.body.specify.member", "When a member is added after the initial introduction of the enclosing class or interface, the details of the member include the release in which it was introduced." },
            { "doclet.help.releases.body.specify.top-level", "The details for each module, package, class or interface normally include the release in which the declaration was introduced." },
            { "doclet.help.releases.head", "Release Details" },
            { "doclet.help.restricted.body", "The {0} page lists all restricted methods. Restricted methods are unsafe, and, if used incorrectly, might crash the JVM or result in memory corruption." },
            ...
            { "doclet.help.searchTags.body", "The {0} page lists search tags defined in the documentation." },
            ...
            { "doclet.search.browser_info", "The URL template below may be useful to configure this page as a search engine or bookmarklet in browsers that support this feature." },
            ...
            { "doclet.search.keyboard_info", "Use the {0}/{1} keys to move between search results and the {2} keys to switch between result tabs." },
            ...
            { "doclet.selectModule", "Select the module to search in." },
            ...
            { "doclet.usage.allow-script-in-comments.description", "Allow JavaScript in documentation comments, and options\nwhose value is html-code" },
            ...
            { "doclet.usage.docfilessubdirs.description", "Enables deep copying of 'doc-files' directories. Subdirectories and all\ncontents are recursively copied to the destination" },
            ...
            { "doclet.usage.footer.description", "This option is no longer supported and reports a warning" },
            { "doclet.usage.footer.parameters", "<html-code>" },
            { "doclet.usage.frames.description", "Enable the use of frames in the generated output" },
            { "doclet.usage.group.description", "Group specified packages or modules together in overview page.\n':' can also be used anywhere in the argument as a separator." },
            ...
            { "doclet.usage.helpfile.description", "Specifies a file containing the text that will be displayed when the\nhelp link in the navigation bar is clicked" },
            ...
            { "doclet.usage.no-fonts.description", "Do not include standard web fonts in generated documentation" },
            ...
            { "doclet.usage.serialwarn.description", "Reports compile-time warnings for missing '@serial' tags" },
            ...
            { "doclet.usage.syntax-highlight.description", "Enable syntax highlighting for code fragments in {@snippet} tags\nand <pre><code> elements." },
            { "doclet.usage.tag.description", "Specifies a custom tag with a single argument" },
