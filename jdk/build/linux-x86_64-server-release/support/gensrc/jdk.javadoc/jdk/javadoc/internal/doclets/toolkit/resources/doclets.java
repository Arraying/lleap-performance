...
public final class doclets extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "doclet.class", "class" },
            { "doclet.contains.diagnostic.markers", "The generated documentation contains diagnostic markers for invalid input." },
            ...
            { "doclet.error.snippet.ambiguous.link", "snippet link tags: {0} and {1} overlap in {2}" },
            ...
            { "doclet.record_equals_doc.fullbody.tail.both", "Reference components are compared with {@link java.util.Objects#equals(Object,Object) Objects::equals(Object,Object)}; primitive components are compared with the <code>compare</code> method from their corresponding wrapper classes." },
            { "doclet.record_equals_doc.fullbody.tail.primitive", "All components in this record class are compared with the <code>compare</code> method from their corresponding wrapper classes." },
