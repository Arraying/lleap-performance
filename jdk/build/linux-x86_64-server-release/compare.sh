...
export OPENJDK_BUILD_OS_ENV="linux"
...
export STRIP="/usr/bin/strip --strip-debug"
export TAR="/usr/bin/tar"
export TEE="/usr/bin/tee"
export UNIQ="/usr/bin/uniq"
export UNARCHIVE="/usr/bin/unzip -q -o"

export TOPDIR="/home/ph/jdks/jdk"
export OUTPUTDIR="/home/ph/jdks/jdk/build/linux-x86_64-server-release"
...
if [ "native" != "cross" ]; then
  ...
  export JAVAP=" @BUILD_JDK@/bin/javap  -J-XX:+UseSerialGC -J-Xms32M -J-Xmx512M -J-XX:TieredStopAtLevel=1"
  export JIMAGE=" @BUILD_JDK@/bin/jimage"
  export JMOD=" @BUILD_JDK@/bin/jmod"
fi
